...
INSERT INTO libro (titulo, anio, sinopsis, fechaSalida, numeroPaginas, genero, autor_id) VALUES ('El otoño del patriarca', 1975, 'El retrato de un dictador caribeño que ha gobernado durante más de dos siglos.', '01/03/1975', 333, 'Realismo mágico', 1);
...
INSERT INTO libro (titulo, anio, sinopsis, fechaSalida, numeroPaginas, genero, autor_id) VALUES ('De amor y de sombra', 1984, 'Una historia de amor ambientada en una dictadura latinoamericana.', '01/01/1984', 274, 'Romance', 2);
...
INSERT INTO libro (titulo, anio, sinopsis, fechaSalida, numeroPaginas, genero, autor_id) VALUES ('Laberintos', 1962, 'Selección de cuentos y ensayos que representan lo mejor de la obra de Borges.', '01/01/1962', 256, 'Cuentos', 3);
...
INSERT INTO libro (titulo, anio, sinopsis, fechaSalida, numeroPaginas, genero, autor_id) VALUES ('Conversación en La Catedral', 1969, 'Un diálogo que reconstruye la historia política y social del Perú bajo la dictadura de Odría.', '01/01/1969', 600, 'Novela', 4);
...
INSERT INTO libro (titulo, anio, sinopsis, fechaSalida, numeroPaginas, genero, autor_id) VALUES ('62 Modelo para armar', 1968, 'Novela experimental derivada del capítulo 62 de Rayuela.', '01/01/1968', 280, 'Novela experimental', 5);
...
INSERT INTO libro (titulo, anio, sinopsis, fechaSalida, numeroPaginas, genero, autor_id) VALUES ('La Galatea', 1585, 'Primera novela de Cervantes, una novela pastoril sobre el amor entre pastores.', '01/01/1585', 312, 'Novela pastoril', 6);
...
INSERT INTO libro (titulo, anio, sinopsis, fechaSalida, numeroPaginas, genero, autor_id) VALUES ('Odas elementales', 1954, 'Poemas que celebran objetos y elementos cotidianos de la vida.', '01/01/1954', 184, 'Poesía', 7);
